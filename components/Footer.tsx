...
export default function Footer() {
  return (
    <footer className="mt-20 border-t-3 border-[#263D5B] bg-white py-8 px-4 text-center">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-xs font-mono font-bold text-[#263D5B] flex items-center gap-1.5 bg-[#49B6E5]/15 px-4 py-2 hand-border">
